...
// Executor manages OpenAI execution lifecycle (stub implementation)
...
// Execute runs OpenAI with the provided project specification (stub)
func (e *Executor) Execute(ctx context.Context, projectSpec map[string]interface{}, outputDir string) (*llm.ExecutionStatus, error) {
	return &llm.ExecutionStatus{
		...
		Error:       "OpenAI provider not yet implemented. Coming soon!",
	}, fmt.Errorf("OpenAI provider not yet implemented. Coming soon!")
}

// Query sends a simple query to OpenAI and returns the response (stub)
func (e *Executor) Query(ctx context.Context, instructions []string, model string) (string, error) {
	return "", fmt.Errorf("OpenAI provider not yet implemented. Coming soon!")
}

// Validate checks if the OpenAI is properly configured (stub)
func (e *Executor) Validate(ctx context.Context) error {
	...
	return fmt.Errorf("OpenAI provider not yet implemented. Please use 'claude' for now")
}
...
func (e *Executor) SetSystemPrompt(systemPrompt string) {
	// TODO: Store system prompt for OpenAI execution
}
